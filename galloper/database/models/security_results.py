...
class SecurityResults(AbstractBaseMixin, Base):
    ...
    scan_time = Column(String(80), unique=False)
    scan_duration = Column(String(80), unique=False)
    project_name = Column(String(80), unique=False)
    app_name = Column(String(80), unique=False)
    dast_target = Column(String(80), unique=False)
    sast_code = Column(String(80), unique=False)
    ...
    environment = Column(String(20), unique=False, nullable=False)

...
class APIReport(AbstractBaseMixin, Base):
    ...
    environment = Column(String(80), unique=False)
    type = Column(String(80), unique=False)
    end_time = Column(String(80), unique=False)
    start_time = Column(String(80), unique=False)
    ...
    build_id = Column(String(80), unique=True)
    lg_type = Column(String(12), unique=False)

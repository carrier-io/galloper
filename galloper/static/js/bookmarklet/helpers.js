export function getFileType(fileExtension, initiatorType) {
	if(fileExtension){
...
export function getRandomColor(baseRangeRed, baseRangeGreen, baseRangeBlue){
	const range = [
...
export function getColourVariation(hexColour, variation) {
...
export function getInitiatorOrFileTypeColour(initiatorOrFileType, fallbackColour, variation){
...
export function getItemCount(arr, keyName) {
	let counts = {},
		resultArr = [],
		obj;

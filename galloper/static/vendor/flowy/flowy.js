var flowy = function(canvas, grab, release, snapping, spacing_x, spacing_y) {
    ...
    function appendExtender() {
       console.log($("#canvas"));
       if (document.getElementById("extender")) {
            $("#extender").remove();
       }
       var x_pos = parseInt($("#canvas").children()[$("#canvas").children().length - 2].style["top"].replace("px", "")) + 100 + "px"
       $("#canvas").append(`<div id="extender" style="position:relative; min-height: 300px; top: ${x_pos};"></div>`);
    }
}
